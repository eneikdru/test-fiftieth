-- Flyway Migration V20260823170105641: Seed and categorize epic sequence 10 design review concern pattern
...
VALUES ('DRC-EPIC-10', 'reviewConcerns', 10, 0.0000, NULL, 'UNCATEGORIZED', CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
