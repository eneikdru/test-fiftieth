-- Flyway Migration V20260826142959075: Seed and categorize SPA Hub Integration design review concern pattern for epic sequence 18
-- Mandatory version: V20260826142959075
...
VALUES ('DRC-EPIC-18', 'reviewConcerns', 18, 0.0000, NULL, 'UNCATEGORIZED', CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
