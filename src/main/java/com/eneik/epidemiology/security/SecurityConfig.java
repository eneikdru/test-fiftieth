    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/documents").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/v1/dossier/reports").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/reports/*").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/reports/*/download").authenticated()
                .requestMatchers("/api/v1/documents/search").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/documents").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/v1/dossier/reports").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/reports/*").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/v1/dossier/reports/*/download").authenticated()
