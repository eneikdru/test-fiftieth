    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/auth/moodle/override-role", "/api/v1/auth/moodle/override-role/**", "/api/v1/auth/moodle/sync-roles").hasRole("ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/documents/**").hasAnyRole("USER", "ADMIN", "EPIDEMIOLOGIST", "RESEARCHER")
                .requestMatchers("/api/v1/dossier/**").hasAnyRole("USER", "ADMIN", "EPIDEMIOLOGIST", "RESEARCHER")
                .requestMatchers("/api/v1/strains/**").hasAnyRole("USER", "ADMIN", "EPIDEMIOLOGIST", "RESEARCHER")
