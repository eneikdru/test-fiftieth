...
class EmployeeDossierControllerTest {
    ...
    void setUp() {
        ...
        otherUser.setCreatedAt(java.time.OffsetDateTime.now());
        otherUser.setPasswordHash("hash");
        userRepository.saveAndFlush(otherUser);

        User epidemiologist = new User();
        epidemiologist.setUsername("epidemiologist");
        epidemiologist.setRole("EPIDEMIOLOGIST");
        epidemiologist.setDepartment("Эпидемиология");
        epidemiologist.setCreatedAt(java.time.OffsetDateTime.now());
        epidemiologist.setPasswordHash("hash");
        userRepository.saveAndFlush(epidemiologist);

        User otherUserSign = new User();
        otherUserSign.setUsername("other_user");
        otherUserSign.setRole("USER");
        otherUserSign.setDepartment("Вирусология");
        otherUserSign.setCreatedAt(java.time.OffsetDateTime.now());
        otherUserSign.setPasswordHash("hash");
        userRepository.saveAndFlush(otherUserSign);
    }
