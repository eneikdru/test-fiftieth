...
@SpringBootTest
@ActiveProfiles("test")
public class RuntimeContractVerificationV20260903065415450Test {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Test
    @DisplayName("Given Flyway migration V20260903065415450, When applied, Then datastore schema complies with runtime contract")
