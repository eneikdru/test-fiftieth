...
@Transactional
public class RuntimeContractVerificationV20260903111254854Test {

    private static final String MIGRATION_FILE_PATH = "db/migration/V20260903111254854__align_datastore_runtime_contract.sql";

    @Autowired
    private DataSource dataSource;

    @Test
    @DisplayName("Given mandatory Flyway migration V20260903111254854, When executed against datastore, Then patch completes cleanly")
