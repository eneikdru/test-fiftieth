...
@SpringBootTest
@ActiveProfiles("test")
public class RuntimeContractVerificationV20260903045204881Test {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Test
    @DisplayName("Given Flyway migration V20260903045204881, When applied, Then datastore schema complies with runtime contract")
