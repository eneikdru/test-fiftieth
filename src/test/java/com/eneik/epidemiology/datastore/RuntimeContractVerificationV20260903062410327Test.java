...
@SpringBootTest
@ActiveProfiles("test")
public class RuntimeContractVerificationV20260903062410327Test {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Test
    @DisplayName("Given Flyway migration V20260903062410327, When applied, Then datastore schema complies with runtime contract")
