...
public class RuntimeContractVerificationV20260906200951125Test {
    ...
    private static final String MIGRATION_FILE_PATH = "db/migration/V20260906200951125__align_datastore_runtime_contract.sql";

    @Autowired
    private DataSource dataSource;

    @Test
    @DisplayName("Given mandatory Flyway migration V20260906200951125, When executed against datastore, Then patch completes cleanly")
