...
class RootCauseCategorizationServiceTest {
    ...
    @Test
    @DisplayName("Given an uncategorized design review concern event from stream reviewConcerns at epic 10, When categorizeConcernInMemory is called, Then assigns rootCausePatternId locally and passes validation")
    void testCategorizeConcernInMemoryEpic10() {
        ...
        DesignReviewConcern concern = new DesignReviewConcern(
            "DRC-EPIC-10", "reviewConcerns", 10, new BigDecimal("0.0000"), null, "UNCATEGORIZED", fixedTime
        );
