...
@Transactional
class RuntimeContractVerificationV20260902194516319Test {

    private static final String MIGRATION_FILE_PATH = "db/migration/V20260902194516319__align_datastore_runtime_contract.sql";

    @Autowired
    private DataSource dataSource;

    @Test
    @DisplayName("Given mandatory Flyway migration V20260902194516319, When executed against datastore, Then patch completes cleanly")
