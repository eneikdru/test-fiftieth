...
@Transactional
class RuntimeContractVerificationV20260831103845614Test {

    private static final String MIGRATION_FILE_PATH = "db/migration/V20260831103845614__align_datastore_runtime_contract.sql";

    @Autowired
    private DataSource dataSource;

    @Test
    @DisplayName("Given mandatory Flyway migration V20260831103845614, When executed against datastore, Then patch completes cleanly")
