...
@SpringBootTest
@Transactional
class RuntimeContractVerificationV20260828043331757Test {

    @Autowired
    private DataSource dataSource;

    @Test
    @DisplayName("Given mandatory Flyway migration V20260828043331757, When executed against datastore, Then patch completes cleanly")
